...
PfkModMaker.exe -i ..\original\enGB.json -s sheet -g "glossary\PathfinderKingmaker - 用語集.csv" -o jpMod\refid\enGB.json -e -k # -m -r

@rem Unity mod manager用CSVファイル作成
PfkModMaker.exe -i ..\original\enGB.json -s sheet -g "glossary\PathfinderKingmaker - 用語集.csv" -o jpMod\umm\jaJP.csv    -u -k # -m -r
